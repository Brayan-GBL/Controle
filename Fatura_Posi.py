...
def processar_analise(cobranca_file, triagem_file):
    ...
    # Converter colunas para string (evita problema de formatação)
    ...
    # Criar chave NF + LOCAL no arquivo de cobrança
    cobranca_df["CHAVE"] = cobranca_df["NF"] + "_" + cobranca_df["LOCAL"]

    # Criar chave NOTA FISCAL + PALLET no arquivo de triagem
